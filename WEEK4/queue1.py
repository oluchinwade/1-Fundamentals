...
class Queue:
    ...
    #creating a method to return the size of the queue
    def size(self):
        return self.num_nodes
    # creating a function to add to the end of the queue
    ...
    #create a function to remove from the head of the queue
    def dequeue(self):
        if self.head is None:
            return None
